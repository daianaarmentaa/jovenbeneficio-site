      ...
      <div className="min-h-screen flex items-center justify-center px-6">
        ...
        >
          <div className="border-b border-gray-200 pb-6">
            <h1 className="text-2xl font-bold text-gray-800"> Registro de Negocios</h1>
            <p className="mt-1 text-sm text-gray-500">Completa la información para crear la cuenta de negocio.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              <label className="label">
                <span className="label-text">Nombre del encargado/a</span>
              </label>
              <input
                type="text"
                name="Dirección"
            ...
            <div className="sm:col-span-2">
              ...
              />
                ...
                <div className="space-y-4">
                  <h2 className="text-lg font-semibold text-gray-700">Foto de perfil</h2>
