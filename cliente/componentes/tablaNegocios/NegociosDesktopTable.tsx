      ...
      <table className="table w-full border border-base-300 text-base-content">
        ...
        <tbody>
          {negocios.map((negocio) => (
            <tr key={negocio.id_establecimiento} className="bg-base-100 hover:bg-base-300">
              <td>
              ...
              <td>{negocio.id_establecimiento}</td>
              <td className="font-semibold">{negocio.nombre}</td>
              ...
              <td className="text-sm">
                <div className="max-w-xs">
                  {(negocio.correos || '').split(' / ').map((email, idx) => (
              ...
              <td className="text-sm">
                <div className="space-y-0.5">
                  {(negocio.telefonos || '').split(' / ').map((phone, idx) => (
